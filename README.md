...
<!-- Badges -->
![Upstream GTSAM](https://img.shields.io/badge/Upstream%20GTSAM-4.3a1--pre--release-orange)
...
This fork is based on **GTSAM 4.3a2** and focuses on:
...
| Ubuntu 22.04 | GCC | 3.10-3.13 | Tested |
...
Install locally:
```bash
pip install wheelhouse/gtsam-4.3a1.dev1-cp311-cp311-win_amd64.whl
```
